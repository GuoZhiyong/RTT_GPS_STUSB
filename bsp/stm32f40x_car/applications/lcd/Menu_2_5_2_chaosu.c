...
static void drawChaoSu_2(void)
{
	...
	lcd_text12(2, 2,(char *)t_s,strlen(t_s),LCD_MODE_SET);
	lcd_text12(2,12,(char *)t_e,strlen(t_e),LCD_MODE_SET);
	lcd_text12(2,22,(char *)sp,strlen(sp),LCD_MODE_SET);
	lcd_update_all();
}
